...
# CHIPDYNO toolbox
# chipDynoGeneAct.R version 1.0.1
# FORMAT chipDynoGeneAct <- function(data, X, Sigma,beta,gamma,mu, 
...
chipDynoGeneAct <- function(data, X, Sigma,beta,gamma,mu, transNames, 
							annotation, geneName) {
